...
export default function AppLayout({ children, auth }) {  // ✅ Принимаем auth
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      >
        <Sidebar onClose={() => setSidebarOpen(false)} auth={auth} />  {/* ✅ Передаём */}
      </div>
      ...
      <div className="hidden lg:block lg:w-64">
        <Sidebar auth={auth} />  {/* ✅ Передаём */}
      </div>

      {/* Основной контент */}
      <div className="flex-1 lg:ml-0">
        <Header onMenuClick={() => setSidebarOpen(true)} auth={auth} />
